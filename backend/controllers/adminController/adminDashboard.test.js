...
describe('adminDashboard function', () => {
  ...
  test('should retrieve dashboard data successfully with category, subcategory and brand wise products', async () => {
    ...
    Product.aggregate.mockResolvedValueOnce([{ _id: 'Makeup', count: 10 }]);
    Product.aggregate.mockResolvedValueOnce([{ _id: 'Foundation', count: 1, products: [{ productId: 234, productName: 'MAC Pro Longwear Foundation', productPrice: 2500, productCategory: 'Makeup', productSubcategory: 'Foundation', productDescription: 'MAC Pro Longwear Foundation offers precision, performance and intense pigmentation without drying the face.', availability: 'instock', productBrandName: 'MAC' }] }]); 
    Product.aggregate.mockResolvedValueOnce([{ _id: 'MAC', count: 6, products: [{ productId: 110, productName: 'MAC Silky Matte Lipstick (Velvet Heart)', productPrice: 2000, productCategory: 'Makeup', productSubcategory: 'Lipstick', productDescription: 'This lightweight formula offers precision, performance and intense pigmentation without drying the lips.', availability: 'instock', productBrandName: 'MAC' }] }]); 
                ...
                products: [
                    {
                        ...
                        productId: 110,
                        productName: 'MAC Silky Matte Lipstick (Velvet Heart)',
                        productPrice: 2000,
                        productCategory: 'Makeup',
                        productSubcategory: 'Lipstick',
                        productDescription: 'This lightweight formula offers precision, performance and intense pigmentation without drying the lips.',
                        availability: 'instock',
                        productBrandName: 'MAC'
                    }
                ]
